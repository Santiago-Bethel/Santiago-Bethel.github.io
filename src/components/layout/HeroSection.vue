    ...
    >
      <header class="text-center lg:text-left">
        ...
        <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
          Soy un apasionado por convertir lógica en soluciones funcionales.
          Como Técnico en Programación Web y estudiante de Ingeniería de Software, 
          me enfoco en el desarrollo de aplicaciones utilizando el ecosistema Java y frameworks modernos como Vue 3.
        </p>
        <div class="mt-6 flex justify-center lg:justify-start">
          <a href="https://wa.me/573028686937" target="_blank">
